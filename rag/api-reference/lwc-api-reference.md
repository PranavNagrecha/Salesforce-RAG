...
**Related Patterns**: <a href="{{ '/rag/mcp-knowledge/lds-patterns.html' | relative_url }}">LDS Patterns</a>, <a href="{{ '/rag/mcp-knowledge/lds-patterns.html#referential-integrity' | relative_url }}">Referential Integrity</a>
...
**Related Patterns**: <a href="{{ '/rag/mcp-knowledge/lwc-best-practices.html#decorators' | relative_url }}">LWC Best Practices</a>
