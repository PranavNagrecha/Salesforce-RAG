...
**Related Patterns**: [Error Handling](/rag/development/error-handling-and-logging.html)

---

## Related Patterns

- [Event-Driven Architecture](/rag/architecture/event-driven-architecture.html) - Complete event-driven patterns
