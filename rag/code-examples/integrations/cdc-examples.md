...
**Related Patterns**:
- [Change Data Capture Patterns](rag/integrations/change-data-capture-patterns.md)
- [Event-Driven Architecture](rag/architecture/event-driven-architecture.md)
...
- [Change Data Capture Patterns](rag/integrations/change-data-capture-patterns.md) - Complete CDC patterns guide
