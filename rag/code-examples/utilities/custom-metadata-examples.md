...
**Related Patterns**:
- [Custom Settings and Custom Metadata Patterns](rag/development/custom-settings-metadata-patterns.md)
...
- [Custom Settings and Custom Metadata Patterns](rag/development/custom-settings-metadata-patterns.md) - Complete patterns guide
