...
**Related Patterns**:
- [Trigger Examples](/rag/code-examples/apex/trigger-examples.html)
- [Apex Patterns](/rag/development/apex-patterns.html)
- [Order of Execution](/rag/development/order-of-execution.html)
