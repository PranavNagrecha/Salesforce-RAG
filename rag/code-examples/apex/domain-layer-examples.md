...
**Related Examples**: [Service Layer Examples](code-examples/apex/service-layer-examples.html)
...
- [Selector Layer Examples](code-examples/apex/selector-layer-examples.html) - Data access patterns
