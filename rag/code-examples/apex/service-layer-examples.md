...
**Related Patterns**: [Service Layer](/Salesforce-RAG/rag/development/apex-patterns.html#service-layer), <a href="{{ '/rag/development/error-handling-and-logging.html' | relative_url }}">Error Handling</a>
