...
permalink: /rag/architecture/architect-role.html
---
...
- <a href="{{ '/rag/architecture/project-estimation.html' | relative_url }}">Project Estimation</a> - Estimating project work
