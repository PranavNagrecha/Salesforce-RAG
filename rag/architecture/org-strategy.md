...
**See Also**:
- [Org Edition Selection](architecture/org-edition-selection.html) - Edition selection for org strategy
- [Governance Patterns](architecture/governance-patterns.html) - Governance implications of org strategy
