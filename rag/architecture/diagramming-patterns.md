...
permalink: /rag/architecture/diagramming-patterns.html
---
...
**See Also**:
- <a href="{{ '/rag/architecture/architect-role.html' | relative_url }}">Architect Role</a> - Architect responsibilities and skills
