...
- [Performance Tuning](performance-tuning.html) - Performance optimization patterns
...
- [Performance Tuning](performance-tuning.html) - Performance optimization and monitoring
- [Change Data Capture Patterns](../integrations/change-data-capture-patterns.html) - CDC monitoring patterns
- [Event-Driven Architecture](../architecture/event-driven-architecture.html) - Platform Events patterns
- [High Availability & DR](ha-dr-patterns.html) - Disaster recovery and failover patterns
