...
**Related Patterns**:
- [LWC Patterns](/rag/development/lwc-patterns.html) - Complements with MCP-validated practices
- [Apex Patterns](/rag/development/apex-patterns.html) - Related backend patterns
