...
<div class="domain-grid">
  ...
  <div class="domain-card">
    ...
    <p>Knowledge extracted from Salesforce MCP Service tools, providing official guidance and best practices.</p>
  </div>
  ...
  <div class="domain-card">
    <h3><a href="{{ '/rag/rag-index.html' | relative_url }}#quick-start-guides">⚡ Quick Start Guides</a></h3>
